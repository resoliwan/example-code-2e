...
async def get_flag(client: httpx.AsyncClient, base_url: str, cc: str) -> bytes:  # <1>
...
async def get_country(client: httpx.AsyncClient, base_url: str, cc: str) -> str:  # <1>
